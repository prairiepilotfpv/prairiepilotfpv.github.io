...
export async function downloadExternalImage(state, htmlfile, href) {
    ...
    await ((_f = state.vfs) !== null && _f !== void 0 ? _f : fsp).writeFile(path.join(state.dir, htmlFolder, filename), buffer);
    return filename;
}
