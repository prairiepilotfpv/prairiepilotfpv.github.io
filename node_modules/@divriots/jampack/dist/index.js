...
program
    ...
    .option('--sequential_compress', 'Whether to perform folder compression sequentially. Reduces memoru footprint on compress. Default: false')
    ...
    try {
        ...
        console.error('Folder `_jampack` is present in target folder. This means that jampack has already processed this folder. You should always run jampack on clean build of the static website.');
        exit(1);
    }
    if (!options.onlycomp) {
